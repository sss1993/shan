                ...
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-5"><h4>添加菜品</h4></p>
                            
                            <br><br>


                            <form action="{{ url('shop/food') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-sm-8">                       
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                                <input type="text" class="form-control" placeholder="请填写菜品名称" name="f_name">
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                                        <div class="fg-line">
                                                <input type="text" class="form-control" placeholder="请填写菜品单价" name="f_price">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                                        <div class="fg-line">
                                            <textarea class="form-control" rows="5" name="f_content" placeholder="请填写菜品简介"></textarea>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <label class="radio radio-inline m-r-20">
                                            <input type="radio" name="f_status" value="1">
                                            <i class="input-helper"></i>  
                                            上架
                                        </label>
                                        <label class="radio radio-inline m-r-20">
                                            <input type="radio" name="f_status" value="2">
                                            <i class="input-helper"></i>  
                                            下架
                                        </label>
